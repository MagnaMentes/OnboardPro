 ...
 * @param {boolean} props.isOpen - Флаг, указывающий открыт ли диалог
 ...
 * @param {boolean} props.isDangerous - Флаг опасного действия (красная кнопка подтверждения)
 */
const ConfirmDialog = ({
  isOpen,
  onClose,
    ...
    <Transition.Root show={isOpen} as={Fragment}>
      ...
      >
        <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          {/* Этот элемент центрирует диалог */}
          <span
