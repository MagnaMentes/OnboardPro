...
## 📣 Последние обновления (29 апреля 2025)

- ✏️ **Добавлена функция редактирования задач** для пользователей с ролью HR
...
- ✏️ Редактирование задач с контролем ролевого доступа (только HR)
