...
## 📣 Последние обновления (6 мая 2025)

- 🐳 **Полный ребилд контейнеров** - произведен полный ребилд Docker-контейнера frontend с оптимизацией зависимостей
- 🧩 **Стабилизация зависимостей** - обновлены критические библиотеки с фиксацией версий для обеспечения стабильности
- 🔄 **Улучшение обновления данных** - оптимизированы запросы к API и механизмы кеширования
- 🚀 **Оптимизация процесса сборки** - улучшен процесс копирования файлов и последовательность шагов сборки
- 🔒 **Усиление безопасности входа** - удаление демо-аккаунтов со страницы входа для повышения безопасности (1 мая)
- 📊 **Улучшенное обновление HR-дашборда в реальном времени** - исправлена проблема с сбросом значений показателей после перезагрузки страницы (1 мая)
- 🔄 **Усовершенствованный механизм кэширования данных** для гарантии актуальности аналитики (1 мая)
- 🛡️ **Улучшенная система инвалидации кэша** с версионированием аналитических данных (1 мая)
- 🔄 **Исправлена функциональность drag-and-drop в календаре** для перетаскивания и изменения дат задач (29 апреля)
- ✏️ **Добавлена функция редактирования задач** для пользователей с ролью HR (29 апреля)
...
4. Войдите, используя учетные данные, предоставленные администратором системы.
