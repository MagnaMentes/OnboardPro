...
## 📣 Последние обновления (1 мая 2025)

- 🔒 **Усиление безопасности входа** - удаление демо-аккаунтов со страницы входа для повышения безопасности
- 📊 **Улучшенное обновление HR-дашборда в реальном времени** - исправлена проблема с сбросом значений показателей после перезагрузки страницы
- 🔄 **Усовершенствованный механизм кэширования данных** для гарантии актуальности аналитики
- 🛡️ **Улучшенная система инвалидации кэша** с версионированием аналитических данных
