...
# Демо-данные для ФИО
demo_first_names = ["Алексей", "Иван", "Сергей", "Дмитрий", "Михаил", "Ольга", "Елена", "Анна", "Мария", "Татьяна"]
demo_last_names = ["Иванов", "Смирнов", "Петров", "Соколов", "Михайлов", "Иванова", "Смирнова", "Петрова", "Соколова", "Михайлова"]
...
def update_users_with_demo_data():
    ...
    for user_id, email, role in users:
        ...
        print(f"Обновлен пользователь {email} ({role}): {last_name} {first_name} {middle_name}, тел: {phone}")
